...
export interface OperatorScope { scopeId: string; entityId?: string; parentScopeId?: string; name: string; state: AttemptState | 'stale'; stale?: boolean; explanation?: OperatorExplanation; explanationVersionId?: string; diagramError?: string; attempts?: OperatorAttempt[]; }
